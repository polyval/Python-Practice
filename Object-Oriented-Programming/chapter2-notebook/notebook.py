...
class Note:
    ...
    def __init__(self, memo, tags=''):
        """
        initialize a note with momo and optional space-separated
        tags. Automatically set the note's creation date and a
        unique id.
        """
        self.memo = memo
        self.tags = tags
    ...
    def match(self, filter):
        """
        Determine if this note matches the filter text. Return True
